...
async function applyMigration() {
  ...
  try {
    console.log('🔧 Applying migration: Add Prevention Course Support...');
    ...
    if (error) {
      ...
      if (queryError) {
        throw new Error('Cannot execute SQL directly. Migration must be applied manually or through Supabase dashboard.');
      }
    }
