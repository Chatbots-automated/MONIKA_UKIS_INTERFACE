/*
  ...
  6. Notes
    - Existing `weight_kg` column kept for backward compatibility
    - Natural weight is calculated only when composition data exists
    - If no composition data, natural_weight_kg will be NULL
*/
