...
const client = new Client({
  connectionString: 'postgresql://postgres.olxnahsxvyiadknybagt:AppleJuice123!@aws-0-eu-central-1.pooler.supabase.com:6543/postgres'
});
...
async function runMigration() {
  try {
    ...
    console.log('\nCreated tables:');
    console.log('  - synchronization_protocols');
    console.log('  - animal_synchronizations');
    console.log('  - synchronization_steps');
    console.log('\nInserted 3 default protocols:');
    console.log('  - Ovsinhr 56');
    console.log('  - GGPG');
    console.log('  - G7G');
    console.log('\nCreated functions:');
    console.log('  - initialize_animal_synchronization()');
    console.log('  - complete_synchronization_step()');
