    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">GVET PRO</p>
        </div>
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-cyan-700 text-white rounded-lg hover:bg-cyan-800 transition-colors font-medium shadow-sm">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            ...
            <div className="bg-cyan-50 p-3 rounded-lg">
              <Euro className="w-6 h-6 text-cyan-700" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-xl shadow-sm p-6 border border-cyan-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl font-bold text-cyan-700">{stats.recentReceived}</span>
            </div>
            <div className="flex items-center justify-between">
                ...
                <div key={idx} className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <div className="flex-1 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <PackagePlus className="w-3 h-3 text-cyan-700" />
                          <span className="text-xs text-gray-600">Priėmimas: {trend.received}</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className="bg-cyan-700 h-2 rounded-full transition-all"
                ...
                {recentBatches.map((batch) => (
                  <div key={batch.id} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer">
                    <div className="bg-cyan-100 p-2 rounded-lg">
                      <PackagePlus className="w-4 h-4 text-cyan-700" />
                    </div>
                    <div className="flex-1">
